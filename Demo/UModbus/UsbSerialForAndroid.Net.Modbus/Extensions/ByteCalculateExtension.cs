...
namespace UsbSerialForAndroid.Net.Modbus.Extensions
{
    public static class ByteCalculateExtension
    {
        ...
        /// <summary>
        /// Calculate CRC table method, this performance is good
        /// </summary>
        ...
        public static string ToBcc(this byte[] data)
        {
            ...
            return (bcc[0] & 0xFF).ToString("X2").ToUpper();
        }
        ...
        /// <returns></returns>
        public static byte ToChecksum(this byte[] buffer)
        {
            int num = 0;
        ...
        /// <param name="buffer"></param>
        /// <returns></returns>
        public static byte ToChecksumNot(this byte[] buffer)
        {
            return (byte)~buffer.ToChecksum();
        }
        ...
        public static ushort ToBcd16FromDecimal(this ushort value)
        {
            ...
            int bcd = 0;
            for (int i = 0; i < 4; i++)
                bcd += (F & value >> (3 - i) * 4) * (int)Math.Pow(10, 3 - i);
            return (ushort)bcd;
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static ushort ToDecimalFromBcd16(this ushort value)
        {
            if (value > 9999)
                throw new ArgumentOutOfRangeException(nameof(value), value, "Bcd range of 0-9999");

            return Convert.ToUInt16(value.ToString(), 16);
        }
    }
}
